    ...
    <div className="min-h-screen">
      ...
      <div className="pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-7xl">
          ...
          {/* Handle loading / error states early to avoid runtime render errors */}
          {isLoading ? (
            <div className="col-span-3 flex justify-center items-center py-24">
            ...
            <div className="col-span-3 flex flex-col items-center justify-center py-24">
              ...
              <Link to="/properties" className="btn-pleasant">
                Back to properties
              </Link>
            </div>
          ) : (
